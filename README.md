...
You only needs to edit the specified lines in **DatasetGeneratorAndBenchMarks.py**. For each axiom and ontology it plots Prover9's time to detect a falsified axiom for each of the four locations.
